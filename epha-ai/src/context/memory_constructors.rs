...
/// Create a builder for a memory fragment from a Publisher message
///
/// Dual timestamp design:
/// - content.original_timestamp: When message was created (Publisher-side)
/// - MemoryFragment.timestamp: When message entered context (epha-ai side, generated by .build())
pub fn from_publisher_message(msg: PublisherMessage) -> MemoryFragmentBuilder {
    let content = json!({
        "type": "publisher_message",
